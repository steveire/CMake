...
function(GENERATE_EXPORT_HEADER TARGET_LIBRARY)
  ...
  if(POLICY CMP0042)
    cmake_policy(GET CMP0042 pol)
    if (pol STREQUAL OLD OR pol STREQUAL WARN)
      if (pol STREQUAL WARN)
        cmake_policy(GET_WARNING CMP0042 warn_message)
        message("${warn_message}")
      endif()
      _test_compiler_hidden_visibility()
      _test_compiler_has_deprecated()
    elseif(pol STREQUAL NEW)
      get_target_property(prop ${TARGET} VISIBILITY_INLINES_HIDDEN)
      if(prop)
        set(COMPILER_HAS_HIDDEN_INLINE_VISIBILITY 1)
      endif()
      get_target_property(prop ${TARGET} CXX_VISIBILITY_PRESET)
      if(prop)
        set(COMPILER_HAS_HIDDEN_VISIBILITY 1)
      else()
        get_target_property(prop ${TARGET} C_VISIBILITY_PRESET)
        if(prop)
          set(COMPILER_HAS_HIDDEN_VISIBILITY 1)
        else()
        endif()
      ...
      if(COMPILER_HAS_HIDDEN_INLINE_VISIBILITY
          OR COMPILER_HAS_HIDDEN_VISIBILITY)
        option(USE_COMPILER_HIDDEN_VISIBILITY
          "Use HIDDEN visibility support if available." ON)
        mark_as_advanced(USE_COMPILER_HIDDEN_VISIBILITY)
      endif()
...
function(add_compiler_export_flags)
  set(deprecated_message "The add_compiler_export_flags function is obsolete. Use the CXX_VISIBILITY_PRESET and VISIBILITY_INLINES_HIDDEN target properties instead.")
  if(NOT CMAKE_MINIMUM_REQUIRED_VERSION VERSION_LESS 2.8.12)
    message(DEPRECATION ${deprecated_message})
  endif()
